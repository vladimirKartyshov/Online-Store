                ...
                <v-card class="elevation-12">
                    ...
                    <v-card-text>
                        <v-form  ref="form" v-model="valid" lazy-validation>
                            ...
                            <v-text-field label="Confirm Password" name="confirm-password" prepend-icon="mdi-repeat" type="password" :counter="6"
                                          :rules="ConfirmPasswordRules" v-model="confirmPassword">
                            </v-text-field>
                        </v-form>
                    </v-card-text>
                    <v-card-actions>
